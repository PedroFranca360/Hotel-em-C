...
int main(){
    ...
    //Chamei a Função CheckOut para auxiliar o usuário na tomada de decisão
    void CheckOut(struct informacoes hotel[andar][ap]);

    //Chamei a Função CancelarReserva para efetuar o cancelamento da reserva já feita
    void CancelarReserva(struct informacoes hotel[andar][ap]);

    //Chamei essa função para informar o usuário a taxa de ocupação do hotel
    void TaxaDeNaoVacancia(struct informacoes hotel[andar][ap]);

    //Chamei essa função para mostrar os dados coletados do usuário
    void MostrarDados(struct informacoes hotel[andar][ap]);
...
void MostrarDados(struct informacoes hotel[andar][ap]){
    ...
    //Aqui vai haver a pergunta de qual dormitório vai exebir os dados
